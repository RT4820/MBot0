 ...
 **
رابط البوت : https://discordapp.com/api/oauth2/authorize?client_id=469687820127174656&permissions=0&scope=bot
 **
`);
  message.author.sendEmbed(embed);
   }
 ...
 **
رابط السيرفر : https://discord.gg/dUhqScC
 **
`);
  message.author.sendEmbed(embed);
   }
...
bl.on("collect", r => {
	...
	msg.channel.send('`تم اعطائك رتبة للعبة GTA `');
	msg.delete();
})
cc.on("collect", r => {
	msg.delete();
...
client.login('NDY5Njg3ODIwMTI3MTc0NjU2.DjN8aQ.fOcL7uRINVZl7vnh4Rn9ytg-qhQ');